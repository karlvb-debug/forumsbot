...
export async function generateQuickStart(promptOverride = "") {
  ...
  const system = [
    ...
    "",
    "## SPECIAL ROLES & MODES",
    "- Director (canDirect: true): moderator (Problem) or narrator/DM (Story). Max 1. canSeeThoughts lets Director read private thoughts.",
    "- Manager (canManageCast: true): dynamically adds/silences/resumes actors.",
    "- Researcher (canResearch: true): runs web searches and reads URLs.",
    "- Story Mode: Actors speak fully in character. Director is DM. No web tools. Premise sets the scene. High temp (1.0-1.2) recommended.",
