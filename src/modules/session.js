...
export async function generateQuickStart(promptOverride = "") {
  ...
  const system = [
    frag('setup_assistant_identity'),
    '',
    frag('setup_assistant_response_format', { patchChangesShape, fullSetupShape: fullSetupShape.slice(1) }),
    '',
    '',
    frag('setup_assistant_concepts'),
    '',
    frag('setup_assistant_scenario_fields'),
    '',
    frag('setup_assistant_actor_fields'),
    '',
    frag('setup_assistant_systems'),
    '',
    frag('setup_assistant_settings'),
    '',
