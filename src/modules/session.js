...
export async function generateQuickStart(promptOverride = "") {
  ...
  const system = [
    ...
    "Keyboard shortcuts: ⌘⇧N next turn · ⌘⇧R run round · ⌘⇧A toggle auto · ⌘K command palette · ⌘⇧I AI assistant · ⌘S save session.",
    "",
    ...
    "",
    "**Document** (doc icon): A shared document all actors can co-edit during the session.",
    "  - Toggle enabled to activate. Actors will propose edits in their JSON output.",
    "  - Preview tab shows rendered output. Edit tab lets you edit directly. History tab shows version log.",
    "",
    ...
    "",
    "**Knowledge** (search icon): Inject reference documents or URLs into actor prompts.",
    "  - Add Document: paste text content (a report, spec, article).",
    "  - Add Link: provide a URL and the app fetches and indexes the content.",
    "  - Each entry can be scoped to specific actors or shared with all.",
    "  - Space is allocated proportionally so larger entries get more prompt budget.",
    "",
    ...
    "",
    "**Document** (Document panel): actors can propose edits to a shared text document.",
    "  - Enable it in the Document panel. Give it a title. Actors will see the current content each turn.",
    "",
