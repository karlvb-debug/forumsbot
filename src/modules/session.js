...
export async function generateQuickStart(promptOverride = "") {
  ...
  const system = [
    ...
    "- Connection: LM Studio server URL, API key, Chat/Embedding model, generation defaults (temp, max tokens, top-P, repeat penalty, streaming).",
    "",
    "## SPECIAL ROLES & MODES",
    "- Director (canDirect: true): moderator or narrator/DM. Max 1. canSeeThoughts lets Director read private thoughts.",
    "- Manager (canManageCast: true): dynamically adds/silences/resumes actors mid-session.",
