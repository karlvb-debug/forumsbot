...
export const ACTOR_LIBRARY = [
  ...
  },
  {
    ...
    persona: 'Does the actual writing. Once the outline is agreed, drafts the manuscript scene by scene into the Story Draft document when given explicit Writer tasks, following the agreed outline, characters, and tone. Writes real prose, not summaries.',
